/* kemcom.f -- translated by f2c (version 20100827).
...
/* Subroutine */ int kemcom_(doublereal *ht, integer *ibegin, integer *iend, 
	...
	doublereal *hr9, doublereal *hr10, doublereal *hr11, doublereal *hr12,
	 doublereal *hr13, doublereal *hf1, doublereal *hs2, doublereal *
	hcomp, doublereal *ddage, integer *itlvl)
{
    /* Format strings */
...
#define b (equiv_0 + 49)
    ...
    static doublereal gr1, gr9, gr2, gr3, gr4, gr5, gr6, gr7, gr8, x2r, y3r, 
	    x3r, x4r, x6r, gr10, gr13, gr11, gr12, xo18, xpr, ypr, bigb, bigd,
	     delt;
    static integer icon;
