/* rotmix.f -- translated by f2c (version 20100827).
...
/* Subroutine */ int rotmix_(doublereal *delts, doublereal *hcomp, doublereal 
	*hs2, doublereal *ht, integer *itlvl, integer *m, integer *mrzone, 
	integer *mxzone, integer *nrzone, integer *nzone, doublereal *hstot, 
	doublereal *hd, doublereal *hs, doublereal *hr, doublereal *hp, 
	logical *lc, doublereal *hs1)
{
    /* Format strings */
