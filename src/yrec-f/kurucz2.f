...
C     SECOND Z TABLE
      ...
      SUBROUTINE KURUCZ2(DL,TL,OF,OLF,QODF,QOTF,*)
...
C     THIS VALUES IS ESTIMATED BY NUMERICAL DIFFERENTIATION.
      ...
      LOGICAL*4 LMORE
      COMMON /GKRZ2/GRIDT(NUMT)
      COMMON /KRZ2/OPACITY(NUMXT,NUMD),RHO(NUMXT,NUMD),NUMTM
      COMMON/LUOUT/ILAST,IDEBUG,ITRACK,ISHORT,IMILNE,IMODPT,ISTOR,IOWR
      COMMON /KIPM2/M1,M2,M3
      COMMON /INTPL22/ CFORD(NUMXT,NUM4D),NDS(NUMXT),NDD(NUMXT)
      DATA  M1,M2,M3/1,1,1/
      SAVE
