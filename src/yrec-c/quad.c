/* quad.f -- translated by f2c (version 20061008).
...
/* *********************************************************************** */
doublereal quad_(integer *ic, integer *i__, doublereal *x, doublereal *y1, 
	doublereal *y2, doublereal *y3, doublereal *x1, doublereal *x2, 
	doublereal *x3)
{
