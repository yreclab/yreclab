/* oeqos.f -- translated by f2c (version 20061008).
...
/*      CA3=2.5214D-15 */
    ...
    *p = pow_dd(&c_b2, p10);
    ...
    irad = 1;
    iorder = 10;
/*       R=RHOOFP(X,ZTAB,T6,P12,IRAD)  ! KC 2025-05-31 */
    r__ = rhoofp_(&x, &t6, &p12, &irad);
    if (r__ <= -998.) {
	return 1;
    }
    *d__ = r__;
    *d10 = d_lg10(d__);
/*       CALL ESAC(X,ZTAB,T6,R,IORDER,IRAD,*999)  ! KC 2025-05-31 */
    switch (esac_(&x, &t6, &r__, &iorder, &irad)) {
	case 1:  goto L999;
    }
