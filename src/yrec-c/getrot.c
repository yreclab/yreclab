/* getrot.f -- translated by f2c (version 20061008).
...
/* JNT 09/25 FOR 05/15 CALL WCZIMP INSTEAD OF WCZ */
	    wczimp_(&hd[1], &hjm[1], &hr[1], &hs[1], &hs2[1], &jstart, &jend, 
