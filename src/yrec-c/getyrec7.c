/* getyrec7.f -- translated by f2c (version 20061008).
...
/* MHP 4/25 padded character strings to proper length */
    s_copy(atm, "  ? ", (ftnlen)4, (ftnlen)4);
    s_copy(eos, "    ? ", (ftnlen)6, (ftnlen)6);
    s_copy(hik, "  ? ", (ftnlen)4, (ftnlen)4);
    s_copy(alok, "  ? ", (ftnlen)4, (ftnlen)4);
