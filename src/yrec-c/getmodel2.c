/* getmodel2.f -- translated by f2c (version 20061008).
...
/* Subroutine */ int getmodel2_(doublereal *bl, doublereal *cfenv, doublereal 
	*cmixl, doublereal *dage, doublereal *ddage, doublereal *ftri, 
	...
	integer *iread, integer *jcore, integer *jenv, logical *lc, logical *
	...
	doublereal *tlumx, doublereal *tril, doublereal *trit, doublereal *ts,
	 char *atm, char *eos, char *hik, logical *ldify, logical *ldifz, 
	logical *ldisk, logical *linstb, logical *ljdot0, char *alok, logical 
	*lovstc, logical *lovste, logical *lovstm, logical *lpurez, logical *
	lsemic, char *compmix, doublereal *pdisk, doublereal *tdisk, 
	doublereal *wmax, ftnlen atm_len, ftnlen eos_len, ftnlen hik_len, 
	ftnlen alok_len, ftnlen compmix_len)
{
    /* Format strings */
    ...
    static char fmt_50[] = "(4x,i2,5f16.12,1p3e20.12)";
...
/*      * HP,HR,HS,HSTOT,HT,IREAD,ISHORT,JCORE,JENV,LC,LEXCOM,LROT,M,  ! KC 2025-05-31 */
