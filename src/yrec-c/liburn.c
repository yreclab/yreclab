/* liburn.f -- translated by f2c (version 20061008).
...
/*       SUBROUTINE LIBURN(DELTS,HCOMP,HD,HR,HS1,HS2,HT,JNENV,JNENV0,M)  ! KC 2025-05-31 */
/* Subroutine */ int liburn_(doublereal *delts, doublereal *hcomp, doublereal 
	*hr, doublereal *hs1, doublereal *hs2, doublereal *ht, integer *jnenv,
	 integer *jnenv0, integer *m)
{
    /* Initialized data */
    ...
    static integer k2;
    static doublereal fm, dr, dt, fx, fm0;
    extern /* Subroutine */ int safedivexp_(doublereal *, doublereal *);
    static doublereal ddj, ros, bbe9, dbe9, fbe9, bli6, bli7, dli6, fli6, 
	    fli7, tbe9, dli7, tli6, tli7, bbe90, fbe90, frac, bli60, bli70, 
	    frad, fli60, fli70;
    static integer minj;
    ...
    /* Fortran I/O blocks */
    static cilist io___32 = { 0, 0, 0, fmt_911, 0 };
    static cilist io___61 = { 0, 6, 0, fmt_913, 0 };
    static cilist io___62 = { 0, 0, 0, fmt_911, 0 };
...
/*          HCOMP(13,I) = HCOMP(13,I)/EXP(DLI6) */
	safedivexp_(&hcomp[i__ * 15 + 13], &dli6);
	if (hcomp[i__ * 15 + 13] < 1e-24) {
	    hcomp[i__ * 15 + 13] = 0.;
	}
/*          HCOMP(14,I) = HCOMP(14,I)/EXP(DLI7) */
	safedivexp_(&hcomp[i__ * 15 + 14], &dli7);
	if (hcomp[i__ * 15 + 14] < 1e-24) {
	    hcomp[i__ * 15 + 14] = 0.;
	}
...
/* $$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$ */
/* Subroutine */ int safedivexp_(doublereal *numerator, doublereal *exponent)
{
    /* Builtin functions */
    double exp(doublereal);

    if (*exponent < 709.7827) {
