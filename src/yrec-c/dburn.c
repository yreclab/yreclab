/* dburn.f -- translated by f2c (version 20061008).
...
/* $$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$ */
/* Subroutine */ int dburn_(integer *ibegin, integer *iend, integer *m, 
	doublereal *hs2, doublereal *hcomp, doublereal *dt)
{
    ...
    /* Local variables */
    static integer i__;
    static doublereal x, r0, xn, xh2, dxh2, xhe3, xh2n, rate, summ, dxh2a, 
	    rate0, rate1, xh2na, dxh2o, xhe3n, xh2no, x2new, sumr0, sumr1, 
	    fstep;
    static integer istep;
    static doublereal tstep, xh2nacc, xh2test, delrate;
...
/*       DATA C21/5.240358E-8/ */
	...
	rate0 = deuter_1.drate0[*ibegin - 1];
	rate1 = deuter_1.drate[*ibegin - 1];
    } else {
	summ = 0.;
	sumr0 = 0.;
	sumr1 = 0.;
	...
	for (i__ = *ibegin; i__ <= i__1; ++i__) {
	    summ += hs2[i__];
	    sumr0 += hs2[i__] * deuter_1.drate0[i__ - 1];
	    sumr1 += hs2[i__] * deuter_1.drate[i__ - 1];
    ...
    if (masschg_1.lmdot && *iend == *m && masschg_1.dmdt0 > 0.) {
	xh2test = (xh2 * summ + masschg_1.compacc[11] * deuter_1.fmassacc) / (
		summ + deuter_1.fmassacc);
    } else {
	xh2test = xh2;
    }
    if (xh2test < 1e-11) {
...
/* AND NEWLY ACCRETED MATTER */
	...
	xh2n = (xh2no * summ + xh2na * deuter_1.fmassacc) / (summ + 
		deuter_1.fmassacc);
	xn = x + (dxh2o * summ + dxh2a * deuter_1.fmassacc) * .5 / (summ + 
		deuter_1.fmassacc);
	xhe3n = xhe3 - (dxh2o * summ + dxh2a * deuter_1.fmassacc) * 1.5 / (
		summ + deuter_1.fmassacc);
    } else {
...
/*      IF(IEND.EQ.M)THEN */
/*      WRITE(*,911)IBEGIN,IEND,DRATE(IBEGIN),RATE0,RATE1, */
/*     *            XH2,XH2N,XHE3,XHE3N */
/*      WRITE(*,*)DXH2O,DXH2A,FMASSACC */
/*      ENDIF */
/* 911  FORMAT(1X,'DBURN: MIX D BURNING',2I5,1P7E12.3) */
    i__1 = *iend;
    for (i__ = *ibegin; i__ <= i__1; ++i__) {
	hcomp[i__ * 15 + 1] = xn;
