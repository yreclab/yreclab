/* zfermim12.f -- translated by f2c (version 20061008).
...
/* ..declare */
/*       double precision x,an,a1(12),b1(12),a2(12),b2(12),rn,den,xx  ! KC 2025-05-31 */
/* ..load the coefficients of the expansion */
/*       data  an,m1,k1,m2,k2 /-0.5d0, 7, 7, 11, 11/  ! KC 2025-05-31 */
    if (*x < 2.) {
	xx = exp(*x);
	rn = xx + a1[m1 - 1];
