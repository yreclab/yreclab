/* grsett.f -- translated by f2c (version 20061008).
	 ...
	 logical *lc, integer *m, doublereal *stot)
{
    ...
    extern /* Subroutine */ int model_to_equal__(doublereal *, doublereal *, 
	    ...
	    integer *, doublereal *, doublereal *, doublereal *, doublereal *,
	     doublereal *, doublereal *, doublereal *, doublereal *, 
	    doublereal *, doublereal *, doublereal *, doublereal *, 
	    doublereal *, integer *), equal_to_model__(doublereal *, 
...
/*       CALL MODEL_TO_EQUAL(COD1,COD2,HCOMP,HQPR,HRU,HS1,HTU,  ! KC 2025-05-31 */
    model_to_equal__(cod1, cod2, &hcomp[16], hru, &hs1[1], &ibegin, &iend, m, 
	    qcod1x, qcod2x, &dr, ecod1, ecod1_h__, ecod2_h__, em, em_h__, 
	    eqcod1x_h__, eqcod2x_h__, er, ex, ex_h__, &npt);
...
/* WITH LDOLI = FALSE, SIGNIFYING THAT LAX_WENDROF SHOULD DIFFUSE Z. */

    ldoli = FALSE_;
    lax_wendrof1__(dt, ecod1, em, &npt, stot, ex_h__, &ldoli);
...
/* TO MINIMIZE ERRORS FROM THE INTERPOLATION. */
    ...
    lax_wendrof2__(dt, ecod1_h__, em_h__, ex, &npt, stot, &ldoli);
