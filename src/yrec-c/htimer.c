/* htimer.f -- translated by f2c (version 20061008).
...
/*      * JXMID,TLUMX,DAGE,DDAGE,QDT,QDP,NK,HP,HR,OMEGA,DWMAX,JXBEG,TEFFL)  ! KC 2025-05-31 */
/* Subroutine */ int htimer_(doublereal *delts, doublereal *deltsh, integer *
	...
	doublereal *ht, doublereal *hcomp, integer *jcore, integer *jxmid, 
	doublereal *tlumx, doublereal *dage, doublereal *ddage, integer *nk, 
	doublereal *hp, doublereal *hr, doublereal *omega, doublereal *dwmax, 
	integer *jxbeg, doublereal *teffl)
{
    /* Format strings */
    ...
    static doublereal eg[6], hf1[5000], hf2[5000], hr1[5000], hr2[5000], hr3[
	    ...
	    5000], hr10[5000], hr11[5000], hr12[5000], hr13[5000], edelt, 
	    pdelt;
    ...
    extern /* Subroutine */ int wtime_(doublereal *, integer *, doublereal *, 
	    ...
	    doublereal *, doublereal *, doublereal *, doublereal *, 
	    doublereal *, doublereal *, doublereal *, doublereal *, 
	    doublereal *, doublereal *, doublereal *), ytime_(doublereal *, 
	    doublereal *, doublereal *, doublereal *, doublereal *, 
	    doublereal *, integer *, integer *, doublereal *, doublereal *, 
	    doublereal *, doublereal *, doublereal *, doublereal *, 
	    doublereal *, doublereal *, doublereal *, doublereal *, 
	    doublereal *, doublereal *, doublereal *, doublereal *, 
	    doublereal *, doublereal *, integer *), entime_(doublereal *, 
	    doublereal *, doublereal *, integer *, doublereal *);
...
/*       DIMENSION HD(JSON),HL(JSON),HS1(JSON),HT(JSON),LC(JSON),  ! KC 2025-05-31 */
...
/*  MORE THAN TRIDL OR TRIDT */
    if (govs_1.ltrist && ! ct3_1.lptime) {
	entime_(delts, &hl[1], teffl, m, &edelt);
    } else {
	edelt = 1e20;
    }
...
/*      IF(LENDAG(NK)) THEN */
    if (sett_1.lendag[*nk - 1] && sett_1.endage[*nk - 1] > 0.) {
