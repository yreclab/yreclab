/* eqstat2.f -- translated by f2c (version 20061008).
	 ...
	 logical *lderiv, logical *latmo, integer *ksaha)
{
    ...
    extern /* Subroutine */ int eqbound01_(doublereal *, doublereal *, 
	    doublereal *, logical *, logical *), eqbound06_(doublereal *, 
    ...
    static doublereal d1, z0, fx[12], dl0, dl1, r1a, wt0, fac, raa, d10o, dpl,
	    ...
	    qcp1, dfx4, qdp1, dtl2, qcp2, qdt1, qdt2, qat1, qdp2, qdt0, qdp0, 
	    qcp0, qat0, qap0, wts2;
    static logical ltab;
    ...
    extern /* Subroutine */ int eqscve_(doublereal *, doublereal *, 
	    doublereal *, doublereal *, doublereal *, doublereal *, 
	    doublereal *, doublereal *, doublereal *, doublereal *, 
	    doublereal *, doublereal *, doublereal *, logical *), oeqos01_(
	    doublereal *, doublereal *, doublereal *, doublereal *, 
	    doublereal *, doublereal *, doublereal *, doublereal *, 
	    doublereal *, doublereal *, doublereal *, doublereal *, 
	    doublereal *, doublereal *, doublereal *, doublereal *, 
	    doublereal *, doublereal *), oeqos06_(doublereal *, doublereal *, 
	    doublereal *, doublereal *, doublereal *, doublereal *, 
	    doublereal *, doublereal *, doublereal *, doublereal *, 
	    doublereal *, doublereal *, doublereal *, doublereal *, 
	    doublereal *, doublereal *, doublereal *, doublereal *), eqrelv_(
	    doublereal *, doublereal *, doublereal *, doublereal *, 
	    doublereal *, doublereal *, doublereal *, doublereal *, 
	    doublereal *, doublereal *, doublereal *, doublereal *, 
	    doublereal *, doublereal *, doublereal *, doublereal *, 
...
/*      *        QDTT,QDTP,QAT,QAP,QCPT,QCPP,X)  ! KC 2025-05-31 */
	goto L200;
    }
...
/*          CALL EQSCVE(TL,T,PL,P,DL,D,X,Z,BETA,BETAI,BETA14,FXION, */
/*      *        RMU,AMU,EMU,ETA,QDT,QDP,QCP,DELA,LCALC)  ! KC 2025-05-31 */
	eqscve_(tl, t, p, dl, d__, x, z__, beta, &fxion[1], qdt, qdp, qcp, 
		dela, &lcalc);
	lscvd = FALSE_;
...
/*      derivatives. */
	    ...
	    ttl = *tl + dtl;
	    *t = pow_dd(&c_b16, &ttl);
/*             CALL EQSCVE(TTL,T,PL,P,DL1,D1,X,Z,BETA,BETAI,BETA14, */
/*      *      FXION,RMU,AMU,EMU,ETA,QDT1,QDP1,QCP1,DELA1,LCALC1)  ! KC 2025-05-31 */
	    eqscve_(&ttl, t, p, &dl1, &d1, x, z__, beta, &fxion[1], &qdt1, &
		    qdp1, &qcp1, &dela1, &lcalc1);
	    ttl = *tl - dtl;
	    *t = pow_dd(&c_b16, &ttl);
/*             CALL EQSCVE(TTL,T,PL,P,DL1,D1,X,Z,BETA,BETAI,BETA14, */
/*      *      FXION,RMU,AMU,EMU,ETA,QDT1,QDP1,QCP1,DELA1,LCALC1)  ! KC 2025-05-31 */
	    ...
	    *t = pow_dd(&c_b16, tl);
	    ppl = *pl + dpl;
	    *p = pow_dd(&c_b16, &ppl);
/*             CALL EQSCVE(TL,T,PPL,P,DL1,D1,X,Z,BETA,BETAI,BETA14, */
/*      *      FXION,RMU,AMU,EMU,ETA,QDT1,QDP1,QCP1,DELA1,LCALC1)  ! KC 2025-05-31 */
	    eqscve_(tl, t, p, &dl1, &d1, x, z__, beta, &fxion[1], &qdt1, &
		    qdp1, &qcp1, &dela1, &lcalc1);
	    ppl = *pl - dpl;
	    *p = pow_dd(&c_b16, &ppl);
/*             CALL EQSCVE(TL,T,PPL,P,DL1,D1,X,Z,BETA,BETAI,BETA14, */
/*      *      FXION,RMU,AMU,EMU,ETA,QDT2,QDP2,QCP2,DELA2,LCALC2)  ! KC 2025-05-31 */
	    eqscve_(tl, t, p, &dl1, &d1, x, z__, beta, &fxion[1], &qdt2, &
		    qdp2, &qcp2, &dela2, &lcalc2);
	    *p = pow_dd(&c_b16, pl);
	    dpl2 = dpl * 2.;
...
/*          CALL EQBOUND(T,D10o,DL0,FAC,LTAB,LRAMP)  ! KC 2025-05-31 */
	    eqbound_(t, &d10o, &fac, &ltab, &lramp);
	    if (! ltab) {
		goto L998;
	    }
...
/*          CALL EQBOUND01(T,D10o,DL0,FAC,LTAB,LRAMP)  ! KC 2025-05-31 */
	    eqbound01_(t, &d10o, &fac, &ltab, &lramp);
...
/*          CALL EQBOUND06(T,D10o,DL0,FAC,LTAB,LRAMP)  ! KC 2025-05-31 */
	    eqbound06_(t, &d10o, &fac, &ltab, &lramp);
