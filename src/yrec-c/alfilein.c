/* alfilein.f -- translated by f2c (version 20061008).
...
struct {
    doublereal dummy1, dummy2, dummy3, dummy4xternalsort_shell__;
} alatm04_;
...
/* created. */
/* Subroutine */ int alfilein_(char *fallard, ftnlen fallard_len)
{
    /* Format strings */
...
L899:
    ...
    do_lio(&c__9, &c__1, fallard, (ftnlen)256);
    e_wsle();
    goto L9999;
/* Error exit */
L900:
