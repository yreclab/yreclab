/* midmod.f -- translated by f2c (version 20061008).
...
/* Subroutine */ int midmod_(doublereal *delts, doublereal *dt, doublereal *
	...
	logical *lc, logical *lfirst, integer *m, doublereal *eta2m, 
	doublereal *hdm, doublereal *hgm, doublereal *hicz, doublereal *him, 
	doublereal *hlm, doublereal *hpm, doublereal *hrm, doublereal *hsbot, 
	doublereal *hstop, doublereal *htm, integer *imin, integer *imax, 
	logical *lallcz, logical *lcm, logical *lczm, logical *lczsur, 
...
/*       CALL ROTMIX(DT,HCOMP,HS2,HTM,5,M,MRZONE,MXZONE,  ! KC 2025-05-31 */
    rotmix_(dt, &hcomp[16], &hs2[1], &htm[1], m, &mrzone[14], &mxzone[13], 
	    nrzone, nzone, hstot, &hdm[1], &hs[1], &hrm[1], &hpm[1], &lczm[1],
	     &hs1[1]);
    i__1 = *m;
    for (i__ = 1; i__ <= i__1; ++i__) {
	i__2 = iend;
