/* rhoofp01.f -- translated by f2c (version 20061008).
...
/* $$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$ */
/*       function rhoofp01(x,ztab,t6,p,irad)  ! KC 2025-05-31 */
doublereal rhoofp01_(doublereal *x, doublereal *t6, doublereal *p, integer *
	irad)
{
    /* Initialized data */
...
/*      IF(IRAD .EQ. 1) PR=4.D0/3.D0*RAT*T6**4   ! MB */
	...
	rdbg = .001;
	idbg = 1;
/*       CALL ESAC01 (XDBG,ZTAB,T6DBG,RDBG,IDBG,IRAD,*999)  ! KC 2025-05-31 */
	switch (esac01_(&xdbg, &t6dbg, &rdbg, &idbg, irad)) {
	    case 1:  goto L999;
	}
    }
    ilo = 2;
...
/*       CALL ESAC01 (X,ZTAB,T6,RHOG1,1,IRAD,*999)  ! KC 2025-05-31 */
    switch (esac01_(x, t6, &rhog1, &c__1, irad)) {
	case 1:  goto L999;
    }
    p1 = eeos_1.eos[0];
    if (p1 > pnr) {
...
/*           CALL ESAC01 (X,ZTAB,T6,RHOG2,1,IRAD,*999)  ! KC 2025-05-31 */
/* Had wrong pointer, see rhog1= ten lines up */
	switch (esac01_(x, t6, &rhog2, &c__1, irad)) {
	    case 1:  goto L999;
	}
	p2 = eeos_1.eos[0];
    }
...
/*       CALL ESAC01 (X,ZTAB,T6,RHOG3,1,IRAD,*999)  ! KC 2025-05-31 */
    switch (esac01_(x, t6, &rhog3, &c__1, irad)) {
	case 1:  goto L999;
    }
    p3 = eeos_1.eos[0];
