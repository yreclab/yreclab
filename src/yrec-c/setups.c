/* setups.f -- translated by f2c (version 20061008).
...
/* SETUPS */
/* $$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$ */
/* MHP 8/25 Passed file names directly instead of through common, as character strings in common blocks can ca
use problems */
/* Subroutine */ int setups_(doublereal *v, char *falex06, char *fallard, 
	char *fatm, char *ffermi, char *fkur, char *fkur2, char *flaol, char *
	flaol2, char *fliv95, char *flldat, char *fmhd1, char *fmhd2, char *
	fmhd3, char *fmhd4, char *fmhd5, char *fmhd6, char *fmhd7, char *
	fmhd8, char *fopal2, char *fpurez, char *fscvh, char *fscvhe, char *
	fscvz, char *opecalex, ftnlen falex06_len, ftnlen fallard_len, ftnlen 
	fatm_len, ftnlen ffermi_len, ftnlen fkur_len, ftnlen fkur2_len, 
	ftnlen flaol_len, ftnlen flaol2_len, ftnlen fliv95_len, ftnlen 
	flldat_len, ftnlen fmhd1_len, ftnlen fmhd2_len, ftnlen fmhd3_len, 
	ftnlen fmhd4_len, ftnlen fmhd5_len, ftnlen fmhd6_len, ftnlen 
	fmhd7_len, ftnlen fmhd8_len, ftnlen fopal2_len, ftnlen fpurez_len, 
	ftnlen fscvh_len, ftnlen fscvhe_len, ftnlen fscvz_len, ftnlen 
	opecalex_len)
{
    /* Format strings */
    ...
    static char fmt_200[] = "(1x,10x,1pe16.8,/)";
    ...
    static char fmt_206[] = "(1p4e16.8,18(/1p4e16.8),/)";
    static char fmt_208[] = "(1p4e16.8,/1p4e16.8,/1p3e16.8,/)";
    ...
    /* Local variables */
    extern /* Subroutine */ int alfilein_(char *, ftnlen);
    static integer i__, j, k, k1, k2;
    extern /* Subroutine */ int setupopac_(doublereal *, doublereal *, char *,
	     char *, char *, char *, char *, char *, char *, char *, char *, 
	    char *, ftnlen, ftnlen, ftnlen, ftnlen, ftnlen, ftnlen, ftnlen, 
	    ftnlen, ftnlen, ftnlen);
    static doublereal cc;
    extern doublereal hra_(doublereal *);
    static doublereal dum1;
    static integer dum2;
    static doublereal dum3;
    static integer dum4;
    static doublereal elec, hmass, cmelec;
    static logical lcatch;
    static doublereal cplnck, cboltz;
    extern /* Subroutine */ int mhdtbl_(char *, char *, char *, char *, char *
    ...
    static cilist io___23 = { 0, 0, 0, fmt_206, 0 };
    static cilist io___24 = { 0, 0, 0, fmt_208, 0 };
    static cilist io___25 = { 0, 0, 0, fmt_203, 0 };
    static cilist io___26 = { 0, 0, 0, fmt_1, 0 };
    static cilist io___27 = { 0, 0, 0, fmt_1, 0 };
    static cilist io___30 = { 0, 0, 0, fmt_1, 0 };
    static cilist io___33 = { 0, 0, 0, fmt_2, 0 };
    static cilist io___34 = { 0, 0, 0, fmt_2, 0 };
    static cilist io___35 = { 0, 0, 0, fmt_3, 0 };


/* JNT 06/14 ADD NTC FOR KURUCZ/CASTELLI 2004 ATM */
/* MHP 8/97 ADDED NTA AND NGA FOR ALLARD ATMOSPHERE */
/* DBGLAOL */
/* MHP 8/25 Reduced declared variables to ones actually used here or passed to other routine */
...
/* CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC */
    setupopac_(&comp_1.xenv, &v[1], falex06, fkur, fkur2, flaol, flaol2, 
	    fliv95, flldat, fopal2, fpurez, opecalex + 256, (ftnlen)256, (
	    ftnlen)256, (ftnlen)256, (ftnlen)256, (ftnlen)256, (ftnlen)256, (
	    ftnlen)256, (ftnlen)256, (ftnlen)256, (ftnlen)256);
/* CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC */
...
use problems */
    if (mhd_1.lmhd) {
	mhdtbl_(fmhd1, fmhd2, fmhd3, fmhd4, fmhd5, fmhd6, fmhd7, fmhd8, (
...
/* OPEN SURFACE PRESSURE TABLE */
	...
	f_open(&o__1);
/* GET ABUNDANCE: */
	io___22.ciunit = atmos2_1.ioatm;
	s_rsfe(&io___22);
	do_fio(&c__1, (char *)&atmos2_1.atmz, (ftnlen)sizeof(doublereal));
	e_rsfe();
/* GET VALUES OF LOG Teff: */
	io___23.ciunit = atmos2_1.ioatm;
	s_rsfe(&io___23);
	for (i__ = 1; i__ <= 76; ++i__) {
	    do_fio(&c__1, (char *)&atmos2c_1.atmtlc[i__ - 1], (ftnlen)sizeof(
		    doublereal));
	}
	e_rsfe();
/* GET VALUES OF LOG G: */
	io___24.ciunit = atmos2_1.ioatm;
	s_rsfe(&io___24);
	for (i__ = 1; i__ <= 11; ++i__) {
	    do_fio(&c__1, (char *)&atmos2c_1.atmglc[i__ - 1], (ftnlen)sizeof(
		    doublereal));
	}
	e_rsfe();
/* GET GRID OF LOG PRESSURE VALUES: */
	for (j = 1; j <= 76; ++j) {
	    io___25.ciunit = atmos2_1.ioatm;
	    s_rsfe(&io___25);
	    for (i__ = 1; i__ <= 11; ++i__) {
		do_fio(&c__1, (char *)&atmos2c_1.atmplc[j + i__ * 76 - 77], (
			ftnlen)sizeof(doublereal));
	    }
	    e_rsfe();
/* L207: */
...
/*                      set the minimum P thereafter. */
	for (j = 1; j <= 76; ++j) {
	    lcatch = FALSE_;
	    for (k = 11; k >= 1; --k) {
		if (atmos2c_1.atmplc[j + k * 76 - 77] <= 0.) {
/*                check if the first non-999 value has been reached. */
/*                if so, set IMIN2. */
		    if (lcatch) {
			fac_1.imin2[j - 1] = k + 1;
