/* oeqos01.f -- translated by f2c (version 20061008).
...
/* does add radiation  corrections */
    ...
    *p = pow_dd(&c_b2, p10);
    ...
    x = *xc;
    ztab = *z__;
/*       R=RHOOFP01(X,ZTAB,T6,P12,IRAD)  ! KC 2025-05-31 */
    r__ = rhoofp01_(&x, &t6, &p12, &irad);
    if (r__ <= -998.) {
	return 1;
    }
    *d__ = r__;
    *d10 = d_lg10(d__);
/*       CALL ESAC01(X,ZTAB,T6,R,IORDER,IRAD,*999)  ! KC 2025-05-31 */
    switch (esac01_(&x, &t6, &r__, &iorder, &irad)) {
	case 1:  goto L999;
    }
