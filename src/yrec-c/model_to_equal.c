/* model_to_equal.f -- translated by f2c (version 20061008).
...
/* $$$$$$ */
/*       SUBROUTINE MODEL_TO_EQUAL(COD1,COD2,HCOMP,HQPR,HRU,HS1,HTU,  ! KC 2025-05-31 */
/* Subroutine */ int model_to_equal__(doublereal *cod1, doublereal *cod2, 
	doublereal *hcomp, doublereal *hru, doublereal *hs1, integer *ibegin, 
	integer *iend, integer *m, doublereal *qcod1x, doublereal *qcod2x, 
	doublereal *dr, doublereal *ecod1, doublereal *ecod1_h__, doublereal *
	ecod2_h__, doublereal *em, doublereal *em_h__, doublereal *
	eqcod1x_h__, doublereal *eqcod2x_h__, doublereal *er, doublereal *ex, 
	doublereal *ex_h__, integer *npt)
{
...
/*      *   HRU(JSON),HS1(JSON),HTU(JSON),QCOD1X(JSON),QCOD2X(JSON),  ! KC 2025-05-31 */
