/* eqbound.f -- translated by f2c (version 20061008).
...
/* OPAL EOS TABLE. */
/*       SUBROUTINE EQBOUND(T,DL,DL0,FAC,LTAB,LRAMP)  ! KC 2025-05-31 */
/* Subroutine */ int eqbound_(doublereal *t, doublereal *dl, doublereal *fac, 
	logical *ltab, logical *lramp)
{
    /* Format strings */
