/* rscale.f -- translated by f2c (version 20061008).
	...
	logical *lc)
{
    ...
    static char fmt_1000[] = "(1x,\002ERROR IN SUBROUTINE RSCALE\002/1x,\002"
	    "RESCALING OF X\002,\002 IN KIND CARD #\002,i3,1x,\002FAILED - DE"
	    "SIRED COMP\002,f9.6/1x,\002GREATER THAN UNITY.  X NOT RESCALE"
	    "D\002)";
    static char fmt_1002[] = "(1x,\002ERROR IN SUBROUTINE RSCALE\002/1x,\002"
	    "RESCALING OF Z\002,\002 IN KIND CARD #\002,i3,1x,\002FAILED - DE"
	    "SIRED COMP\002,f9.6/1x,\002GREATER THAN UNITY.  Z NOT RESCALE"
	    "D\002)";
    static char fmt_1004[] = "(1x,\002ERROR IN SUBROUTINE RSCALE\002/1x,\002"
	    "RESCALING OF \002,\002SPECIES \002,i3,\002 IN KIND CARD # \002,i"
	    "3,\002 FAILED - DESIRED COMP\002,f9.6/1x,\002GREATER THAN UNITY."
	    "  Z NOT RESCALED\002)";
    ...
    static integer icomp, jxend, jxmid;
    ...
    static cilist io___9 = { 0, 0, 0, fmt_1004, 0 };
