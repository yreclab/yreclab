/* liburn2.f -- translated by f2c (version 20061008).
...
/*       SUBROUTINE LIBURN2(DELTS,HCOMP,HD,HR,HS1,HS2,HT,JNENV,JNENV0,M)  ! KC 2025-05-31 */
/* Subroutine */ int liburn2_(doublereal *delts, doublereal *hcomp, 
	doublereal *hr, doublereal *hs1, doublereal *hs2, doublereal *ht, 
...
/*       DIMENSION HCOMP(15,JSON),HD(JSON),HS2(JSON),HT(JSON),HS1(JSON)  ! KC 2025-05-31 */
/*       DATA TLIM/6.0D0/ */
