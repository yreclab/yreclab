/* bursmix.f -- translated by f2c (version 20061008).
	...
	m, integer *mrzone, integer *mxzone, integer *nrzone, integer *nzone)
{
    ...
    static integer iii, jjj, ibeg, jbeg, iend, jend;
    ...
    extern /* Subroutine */ int rotmix_(doublereal *, doublereal *, 
	    ...
	    doublereal *, doublereal *, logical *, doublereal *), liburn2_(
	    doublereal *, doublereal *, doublereal *, doublereal *, 
	    doublereal *, doublereal *, integer *, integer *, integer *), 
	    ndifcom_(doublereal *, doublereal *, doublereal *, doublereal *, 
	    doublereal *, doublereal *, doublereal *, doublereal *, 
	    doublereal *, doublereal *, doublereal *, doublereal *, 
    ...
    /* Fortran I/O blocks */
    static cilist io___19 = { 0, 6, 0, fmt_5, 0 };
...
/*             CALL ROTMIX(DT,HCOMP,HS2,HT,5,M,MRZONE,MXZONE,  ! KC 2025-05-31 */
	    rotmix_(&dt, &hcomp[16], &hs2[1], &ht[1], m, &mrzone[14], &mxzone[
		    13], nrzone, nzone, hstot, &hd[1], &hs[1], &hr[1], &hp[1],
		     &lcz[1], &hs1[1]);
/* PERFORM MIXING */
	    ndifcom_(&dt, &cod2[1], ecod2, em, &hd[1], &hl[1], &hp[1], &hr[1],
		     &hs[1], &hs1[1], &hs2[1], hstot, &hv[1], &ibeg, &iend, 
		    imax, imin, &lcz[1], lok, m, &hcomp[16], &jbeg, &jend);
/*      *                   HSTOT,HV,IBEG,IEND,IMAX,IMIN,LCZ,LOK,M,NTOT,  ! KC 2025-05-31 */
	    if (flag_1.lexcom) {
/*                CALL LIBURN2(DT,HCOMP,HD,HR,HS1,HS2,HT,JENV1,JENV0,M)  ! KC 2025-05-31 */
		liburn2_(&dt, &hcomp[16], &hr[1], &hs1[1], &hs2[1], &ht[1], 
			jenv1, jenv0, m);
	    }
	    i__3 = *m;
