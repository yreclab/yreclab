/* getw.f -- translated by f2c (version 20061008).
...
/* Subroutine */ int getw_(doublereal *bl, doublereal *delts, doublereal *
	...
	doublereal *ht, logical *lc, logical *ljdot, integer *m, doublereal *
	smass, doublereal *teffl, doublereal *eta2, doublereal *hg, 
	doublereal *hi, doublereal *omega, doublereal *qiw, doublereal *r0, 
	integer *jenv0)
{
    /* Format strings */
    ...
    static doublereal dr, dt, hv[5000], fx, rl, qw, r0m[5000], hdm[5000], hgm[
	    5000];
    ...
    extern /* Subroutine */ int physic_(doublereal *, doublereal *, 
	    doublereal *, doublereal *, doublereal *, doublereal *, 
	    doublereal *, doublereal *, doublereal *, doublereal *, logical *,
	     integer *, doublereal *), getrot_(doublereal *, doublereal *, 
	    doublereal *, doublereal *, doublereal *, logical *, integer *, 
	    doublereal *, doublereal *, doublereal *, doublereal *, 
	    doublereal *), gettau_(doublereal *, doublereal *, doublereal *, 
	    doublereal *, doublereal *, doublereal *, doublereal *, 
	    doublereal *, doublereal *, doublereal *, doublereal *, integer *,
	     logical *, doublereal *), wczimp_(doublereal *, doublereal *, 
    ...
    extern /* Subroutine */ int seculr_(doublereal *, doublereal *, 
	    ...
	    doublereal *, doublereal *, doublereal *, logical *, doublereal *,
	     doublereal *, logical *);
    static integer mxzone[24]	/* was [12][2] */;
    ...
    extern /* Subroutine */ int liburn2_(doublereal *, doublereal *, 
	    doublereal *, doublereal *, doublereal *, doublereal *, integer *,
	     integer *, integer *), lirate88_(doublereal *, doublereal *, 
	    doublereal *, integer *, integer *), bursmix_(doublereal *, 
	    doublereal *, doublereal *, doublereal *, doublereal *, 
	    doublereal *, doublereal *, doublereal *, doublereal *, 
	    doublereal *, doublereal *, doublereal *, doublereal *, integer *,
    ...
    /* Fortran I/O blocks */
    static cilist io___59 = { 0, 6, 0, fmt_9911, 0 };


/*      *             HS1,HS2,HSTOT,HT,LC,LJDOT,M,MODEL,SJTOT,SMASS,  ! KC 2025-05-31 */
...
/*            FRACSTEP = 1. */
	    ...
	    mwind_(bl, delts, &hsbot, &hstop, &imax, m, ljdot, &omegas, smass,
		     teffl, &hicz, &hjm[1]);
...
/* JNT 09/2025 FOR 05/15 REPLACE WCZ WITH WCZIMP */
	    wczimp_(&hd[1], &hjm[1], &hr[1], &hs[1], &hs2[1], &imax, &iend, &
...
/* JVS */
    midmod_(delts, &dt, &fx, &hcomp[16], &hd[1], &hg[1], &hjm[1], &hl[1], &hp[
	    1], &hr[1], &hs[1], &hs1[1], &hs2[1], hstot, &ht[1], &lc[1], &
...
/*      *            HSTOT,HT,LC,LCZ,LFIRST,M,ETA2M,HDM,HGM,HICZ,HIM,  ! KC 2025-05-31 */
...
/* MHP 10/02 REPLACED IEND WITH M IN CALL, DEFINED IEND=M */
	    iend = *m;
/* JNT 09/2025 FOR 05/15 REPLACE WCZ WITH WCZIMP */
	    wczimp_(hdm, &hjm[1], hrm, &hs[1], &hs2[1], &imax, &iend, eta2m, 
		    him, omegam, qiwm, r0m, m);
	}
    }
...
/*      *               HSTOT,SJTOT,SMASS,TEFFL,LREDO,IREDO,  ! KC 2025-05-31 */
	seculr_(&dt, hdm, hgm, him, hlm, hpm, hrm, &hs[1], &hs1[1], &hs2[1], 
		htm, hjmsav, lczm, m, omegam, &hjm[1], eta2m, qiwm, r0m, &
		hcomp[16], &imin, &imax, bl, hstot, smass, teffl, &lredo, &
		iredo, &hicz, &hsbot, &hstop, &omegas, &lczsur, cod2, hv, &
		lok);
...
/*             CALL LIBURN(DT,HCOMP,HDM,HRM,HS1,HS2,HTM,JENV1,JENV0,M)  ! KC 2025-05-31 */
	    liburn_(&dt, &hcomp[16], hrm, &hs1[1], &hs2[1], htm, &jenv1, 
		    jenv0, m);
	    *jenv0 = jenv1;
...
/*             CALL LIBURN2(DT,HCOMP,HDM,HRM,HS1,HS2,HTM,JENV1,JENV0,M)  ! KC 2025-05-31 */
	    liburn2_(&dt, &hcomp[16], hrm, &hs1[1], &hs2[1], htm, &jenv1, 
		    jenv0, m);
	}
/*  ENSURE THAT CONVECTIVE REGIONS ARE FULLY MIXED. */
/*  JVS 0212       CALL MIXCZ(HCOMP,HS2,LCZM,M) */
