/* rhoofp06.f -- translated by f2c (version 20061008).
...
/* $$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$ */
/*       function rhoofp06(x,ztab,t6,p,irad)  ! KC 2025-05-31 */
doublereal rhoofp06_(doublereal *x, doublereal *t6, doublereal *p, integer *
	irad)
{
    /* Initialized data */
...
/* Mb */
	...
	rdbg = .001;
	idbg = 1;
/*       CALL ESAC06 (XDBG,ZTAB,T6DBG,RDBG,IDBG,IRAD,*999)  ! KC 2025-05-31 */
	switch (esac06_(&xdbg, &t6dbg, &rdbg, &idbg, irad)) {
	    case 1:  goto L999;
	}
    }
    ilo = 2;
...
/*       call esac06 (x,ztab,t6,rhog1,1,0,*999)  ! KC 2025-05-31 */
    switch (esac06_(x, t6, &rhog1, &c__1, &c__0)) {
	case 1:  goto L999;
    }
    p1 = eeos06_1.eos[0];
    if (p1 > pnr) {
...
/*           call esac06 (x,ztab,t6,rhog2,1,0,*999)  ! KC 2025-05-31 */
/* Had wrong pointer, see rhog1= ten lines up */
	switch (esac06_(x, t6, &rhog2, &c__1, &c__0)) {
	    case 1:  goto L999;
	}
	p2 = eeos06_1.eos[0];
    }
...
/* KC 2025-05-31 */
    switch (esac06_(x, t6, &rhog3, &c__1, &c__0)) {
	case 1:  goto L999;
    }
    p3 = eeos06_1.eos[0];
...
/* and crashing the program during certain model runs. - MR 2025-10-10 */
    if ((d__1 = (p3 - pnr) / pnr, abs(d__1)) < 1e-5) {
