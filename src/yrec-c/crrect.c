/* crrect.f -- translated by f2c (version 20061008).
...
/* Subroutine */ int crrect_(doublereal *delts, integer *m, integer *niter, 
	...
	doublereal *qdt, doublereal *qdp, doublereal *fp, doublereal *ft, 
	doublereal *eta2, doublereal *omega, doublereal *r0, integer *itdone, 
	doublereal *hg, doublereal *hi, doublereal *hjm, integer *itlvl, 
	logical *lcz, integer *mxzone, doublereal *qiw, doublereal *hkerot, 
	doublereal *hkerot0)
{
    /* Format strings */
    ...
    static integer ksaha, jcore, nspec;
    ...
    extern /* Subroutine */ int coefft_(doublereal *, integer *, doublereal *,
	    ...
	    integer *, doublereal *, doublereal *, doublereal *, doublereal *,
	     integer *, doublereal *), surfbc_(doublereal *, doublereal *, 
	    doublereal *, doublereal *, doublereal *, doublereal *, 
	    doublereal *, integer *, doublereal *, logical *, logical *, 
	    integer *, integer *, integer *, doublereal *, doublereal *, 
	    doublereal *, doublereal *, doublereal *, doublereal *, 
	    doublereal *, logical *, doublereal *, logical *, integer *), 
	    hsolve_(integer *, doublereal *, doublereal *, doublereal *);
    ...
    static cilist io___21 = { 0, 0, 0, fmt_75, 0 };
    static cilist io___28 = { 0, 0, 0, fmt_60, 0 };
    static cilist io___29 = { 0, 0, 0, fmt_70, 0 };
    static cilist io___30 = { 0, 0, 0, fmt_75, 0 };
...
/*      *OMEGA,R0,ITDONE,HG,HI,HJM, ITLVL,LCZ,MRZONE,MXZONE,NRZONE,NZONE,  ! KC 2025-05-31 */
...
/*      *          LCZ(JSON),QIW(JSON),MRZONE(13,2)  ! KC 2025-05-31 */
...
/* FIND ENVELOPE MASS AND SET X AND Z TO ENVELOPE VALUES */
	...
	surfbc_(&trit[1], &tril[1], &cfenv[1], &ps[1], &ts[1], &rs[1], ftri, 
		istore, &estore[1], lnew, lreset, &ksaha, &kenv, &katm, hstot,
		 bl, teffl, &x, &z__, &fpl, &ftl, &lflp, &plim, &lc[1], m);
...
/* L2: */
	...
	mix_(delts, &hcomp[16], &hd[1], &hl[1], &hp[1], &hr[1], &hs[1], &hs1[
		1], &hs2[1], hstot, &ht[1], itlvl, &lc[1], m, &ddage, &jcore, 
		&jenv, &mxzone[13], mxzon0, teffl);
...
/* DO HENYEY REDUCTION */
	...
	coefft_(delts, m, &hd[1], &hha[13], &hhb[5], &hhc[1], &hl[1], &hmax[1]
		...
		locond, qdt, qdp, &ksaha, &fp[1], &ft[1], &hkerot[1], &
		hkerot0[1], &jenv, teffl);
