/* dadcoeft.f -- translated by f2c (version 20061008).
...
/* Subroutine */ int dadcoeft_(doublereal *dr, doublereal *dt, doublereal *ei,
	 doublereal *ew, integer *ntot, doublereal *wind1, doublereal *wind2, 
	doublereal *dj, doublereal *ecod2, doublereal *sumdj, logical *lfix, 
	logical *lokad)
{
    /* Format strings */
    ...
    static doublereal v0, v1, v2, v3, pmmsoltau, aa[80000]	/* was [8000][
	    10] */;
    static integer ii, nm, nn;
    static doublereal dw, fx, wm[5000], wn, wp, dt0, dw2, v1e, fx1[5000], wm0[
	    5000], w2m, dwi, ewt[5000];
    static integer nnn;
    static doublereal wmi, wmp[5000], fxx, dww;
    static integer iww, iwi;
    static doublereal qwr[5000], wmm, dwi2, qwr2, fact, delj, corr, dwit[50], 
	    ewit[5000];
    static integer ncut, iwit[50];
    static doublereal sumj, tiny;
    static integer nnnn;
    static doublereal wsat, qwri, vthn, qwrp[5000], vthp, fact0, vtot, delj0, 
	    ewit2[5000], sumj2, facta, vtot2;
    extern /* Subroutine */ int bandw_(doublereal *, integer *, doublereal *);
    ...
    static cilist io___70 = { 0, 6, 0, fmt_100, 0 };
    static cilist io___72 = { 0, 6, 0, 0, 0 };
    static cilist io___73 = { 0, 6, 0, 0, 0 };
    static cilist io___74 = { 0, 6, 0, fmt_914, 0 };
    static cilist io___82 = { 0, 6, 0, fmt_911, 0 };
...
/* ADD ROSSBY SCALING IF DESIRED. */
		if (lrossby) {
		    wsat = cwind_1.wmax * pmmsoltau / ovrtrn_1.taucz;
		} else {
		    wsat = cwind_1.wmax;
		}
