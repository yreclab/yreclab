/* cowind.f -- translated by f2c (version 20061008).
...
/*  EXMD,EXW,EXR,EXM,CONSTFACTOR : USER PARAMETERS WHICH VARY THE STRENGTH */
...
/*  INDEX ALFA;SEE PARMIN FOR DETAILS ON THE DEPENDENCE OF EACH ON ALFA. */
    ...
    c__ = *dt / *hicz * cwind_1.constfactor * pow_dd(&d__1, &cwind_1.exmd) * 
