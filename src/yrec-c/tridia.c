/* tridia.f -- translated by f2c (version 20061008).
...
/* Subroutine */ int tridia_(integer *n, doublereal *ei, doublereal *dj, 
	doublereal *sumdj)
{
...
/*       DIMENSION EI(JSON),EJ(JSON),DJ(JSON),U0(JSON)  ! KC 2025-05-31 */
