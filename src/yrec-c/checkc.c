/* checkc.f -- translated by f2c (version 20061008).
...
/* JvS 09/25 UPDATED NAMES IN COMMON BLOCK FOR CONSISTENCY ACROSS ALL SUBROUTINES */
...
/*  CORRECTION FOR PARTIAL IONIZATION NEEDED IN MASSIVE STARS. */
	...
	for (i__ = 1; i__ <= i__1; ++i__) {
	    ...
	    temp = hcomp[i__ * 15 + 1] / atomwt[0] + (hcomp[i__ * 15 + 4] / 
		    ...
		    i__ * 15 + 3] * .5;
	    emu2 = 1. / temp;
	    mdphy_1.amum[i__ - 1] = amu2 * emu2 / (amu2 + emu2);
/* L90: */
	}
    }
L100:
