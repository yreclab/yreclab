/* hpoint.f -- translated by f2c (version 20061008).
...
/* Subroutine */ int hpoint_(integer *m, doublereal *hstot, doublereal *hs, 
	...
	*fp, doublereal *ft, doublereal *hg, doublereal *qiw, doublereal *
	teffl)
{
    /* Initialized data */
    ...
    static integer im;
    static doublereal hj, dr, dw, ds1, ds2, ds3, fac, chi[5000];
    static logical lcz[5000];
    static doublereal fpx[5000], ftx[5000], hfo[5000], hko[5000];
    ...
    static doublereal hpmax[4], wlbot;
    static logical ldone;
    static doublereal wltop;
    ...
    extern /* Subroutine */ int splinc_(doublereal *, doublereal *, 
	    doublereal *, integer *);
    static integer mrzone[26]	/* was [13][2] */, mxzone[24]	/* was [12][2]
	     */;
    extern /* Subroutine */ int osplin_(doublereal *, doublereal *, 
	    doublereal *, doublereal *, integer *, integer *);
    static integer minmin, nrzone;
    ...
    static cilist io___25 = { 0, 0, 0, fmt_185, 0 };
    static cilist io___47 = { 0, 6, 0, fmt_101, 0 };
    static cilist io___68 = { 0, 0, 0, fmt_910, 0 };
    static cilist io___69 = { 0, 0, 0, fmt_920, 0 };
    static cilist io___70 = { 0, 0, 0, fmt_930, 0 };
    static cilist io___71 = { 0, 0, 0, fmt_940, 0 };
    static cilist io___73 = { 0, 0, 0, fmt_1020, 0 };
    static cilist io___85 = { 0, 0, 0, fmt_1120, 0 };
