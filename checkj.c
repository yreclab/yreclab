/* checkj.f -- translated by f2c (version 20100827).
...
/* Subroutine */ int checkj_(doublereal *hd, doublereal *hjmp, doublereal *
	...
	hv, integer *imin, integer *imax, integer *it, logical *lcz, logical *
	lprt, integer *m, doublereal *dt, doublereal *eta2, doublereal *hi, 
	doublereal *hjm, integer *iredo, logical *lok, logical *lredo, 
	doublereal *omega, doublereal *qiw, doublereal *r0, doublereal *wsav, 
	integer *id, integer *idm, logical *lokad)
{
    /* Format strings */
