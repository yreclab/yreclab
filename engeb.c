/* engeb.f -- translated by f2c (version 20100827).
...
static doublereal c_b10 = .6666667;
static doublereal c_b11 = .666667;
static doublereal c_b12 = .86;
static doublereal c_b13 = .58;
static doublereal c_b14 = .28;
...
/* Subroutine */ int engeb_(doublereal *epp1, doublereal *epp2, doublereal *
	...
	pet, doublereal *sum1, doublereal *dl, doublereal *tl, doublereal *
	pdt, doublereal *pdp, doublereal *x, doublereal *y, doublereal *z__, 
	doublereal *xhe3, doublereal *xc12, doublereal *xc13, doublereal *
	xn14, doublereal *xn15, doublereal *xo16, doublereal *xo17, 
	doublereal *xo18, doublereal *xh2, doublereal *xli6, doublereal *xli7,
	 doublereal *xbe9, integer *iu, doublereal *hr1, doublereal *hr2, 
	 ...
	 doublereal *hf2)
{
    ...
    static doublereal zo, zz, da1, el2, dr1, tm1, ez3, ex1, ex2, ex3, 
	    be7electron, eli, amu, emu, rwe, zet, trm, rho, t9m1, t9m2, uwk, 
	    snu, xxl, xtr, t9m12, t9m13, t9m23, t9m32, t9p13, t9p23, sum2, 
	    ...
	    polx11, polx12, polx21, polx22, polx31, zcurl, polx32, qetnx, 
...
/* NO SHORTER THAN THE CONVECTIVE OVERTURN TIMESCALE. */
	if (*iu >= deuter_1.jcz && deuter_1.taucz > 1.) {
	    rdeutmax = 6.023e23 / anuc[2] / deuter_1.taucz;
	    rdeut2 = rdeut * *x;
	    if (rdeut2 > rdeutmax) {
		s_wsle(&io___54);
		do_lio(&c__5, &c__1, (char *)&rdeut2, (ftnlen)sizeof(
			doublereal));
		do_lio(&c__5, &c__1, (char *)&rdeutmax, (ftnlen)sizeof(
			doublereal));
		e_wsle();
		if (*x > 1e-6) {
		    rdeut = rdeutmax / *x;
...
/*  IN THE EXPRESSIONS FOR PFMC2 AND EFMKT. */
    pfmc2 = pow_dd(&rwe, &c_b10) * 1.017677e-4f;
...
/*  EXPRESSIONS ARE GIVEN IN TABLE 4 AND EQUATION (19) OF GRABOSKE ET AL. */
    ...
    xxl6 = pow_dd(&xxl, &c_b11);
    xxl8 = pow_dd(&xxl, &c_b12);
    zcurl = sqrt((zet + fprf * emu) / amu);
    zbar = emu / amu;
    z58 = pow_dd(&zcurl, &c_b13);
    z28 = pow_dd(&zbar, &c_b14);
