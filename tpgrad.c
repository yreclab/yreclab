/* tpgrad.f -- translated by f2c (version 20100827).
...
static doublereal c_b21 = -.333333333;
	...
	doublereal *ftl)
{
    ...
    static integer iter;
    static doublereal test, temp1, temp2, temp3, delpm, deldel, qdelap, 
	    qddelp, qdelat, qddelt, phiphi, presht, tempop, tempot;

    /* Fortran I/O blocks */
    static cilist io___10 = { 0, 6, 0, fmt_201, 0 };
    static cilist io___11 = { 0, 6, 0, fmt_911, 0 };
