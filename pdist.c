/* pdist.f -- translated by f2c (version 20100827).
...
/* MHP 10/02 added proper dimensions to last 2 variables */
	...
	*polen = 0.;
	ioccol = i_indx(lufnm_1.fpmod, " ", (ftnlen)256, (ftnlen)1) - 1;
	if (*modeln < 10000) {
	    s_wsfi(&io___9);
...
/* Writing concatenation */
	    i__1[0] = ioccol, a__1[0] = lufnm_1.fpmod;
...
/* Writing concatenation */
	...
	o__1.oblnk = 0;
	f_open(&o__1);
	ioccol = i_indx(lufnm_1.fpenv, " ", (ftnlen)256, (ftnlen)1) - 1;
	if (*modeln < 10000) {
	    s_wsfi(&io___12);
	    do_fio(&c__1, (char *)&zramp_1.nk, (ftnlen)sizeof(integer));
	    do_fio(&c__1, (char *)&(*modeln), (ftnlen)sizeof(integer));
	    e_wsfi();
/* Writing concatenation */
	    i__1[0] = ioccol, a__1[0] = lufnm_1.fpenv;
	    i__1[1] = 7, a__1[1] = ctemp;
	    s_cat(cout, a__1, i__1, &c__2, (ftnlen)256);
	} else {
	    s_wsfi(&io___13);
...
/* Writing concatenation */
	...
	o__1.oblnk = 0;
	f_open(&o__1);
	ioccol = i_indx(lufnm_1.fpatm, " ", (ftnlen)256, (ftnlen)1) - 1;
	if (*modeln < 10000) {
	    s_wsfi(&io___14);
	    do_fio(&c__1, (char *)&zramp_1.nk, (ftnlen)sizeof(integer));
	    do_fio(&c__1, (char *)&(*modeln), (ftnlen)sizeof(integer));
	    e_wsfi();
/* Writing concatenation */
	    i__1[0] = ioccol, a__1[0] = lufnm_1.fpatm;
	    i__1[1] = 7, a__1[1] = ctemp;
	    s_cat(cout, a__1, i__1, &c__2, (ftnlen)256);
	} else {
	    s_wsfi(&io___15);
