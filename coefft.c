/* coefft.f -- translated by f2c (version 20100827).
...
/* Subroutine */ int coefft_(doublereal *delts, integer *m, doublereal *hd, 
	...
	doublereal *qdt, doublereal *qdp, integer *ksaha, integer *model, 
	doublereal *fp, doublereal *ft, doublereal *hkerot, doublereal *
	hkeroto, integer *jenv)
{
    ...
    static doublereal hr1[5000], hr2[5000], hr3[5000], hr4[5000], hr5[5000], 
	    ...
	    , xc12, xc13, thl, xn14, xn15, xo16, xo17, xo18, fpl, ftl, rmu, 
	    ...
	    qact, qdtt, qdtp, qcpt, qcpp, qacp, qacr, httt, hppp, entr;
    static logical long__;
    static doublereal chrh, etot, entr1, entr2, entr3, beta14;
...
/* SET UP NUCLEAR ENERGY TERMS */
	    engeb_(&egg11, &egg22, &egg33, &egg44, &egg55, &qed, &qet, &sum1, 
		    &dl, &tl, qdt, qdp, &x, &y, &z__, &xhe3, &xc12, &xc13, &
		    xn14, &xn15, &xo16, &xo17, &xo18, &xh2, &xli6, &xli7, &
		    xbe9, &iu, hr1, hr2, hr3, hr4, hr5, hr6, hr7, hr8, hr9, 
		    hr10, hr11, hr12, hr13, hf1, hf2);
	    e = sum1;
	    eg[0] = egg11;
	    eg[1] = egg22;
	    eg[2] = egg33;
...
/* DBG 3/91 CHANGED TO ALWAYS EXECUTE THIS STUFF */
	long__ = *model % ccout1_1.nprt2 == 0 || rot_1.lrot;
