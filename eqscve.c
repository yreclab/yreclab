/* eqscve.f -- translated by f2c (version 20100827).
...
/* EQUATION OF STATE. */
/* Subroutine */ int eqscve_(doublereal *tl, doublereal *t, doublereal *pl, 
...
/*     *     FP(4),FPD(4),TEMPT(5),TEMP(4,5),FXION(3) */
	...
	eqscvg_(tl, t, pl, p, dl, d__, x, z__, beta, betai, beta14, &fxion[1],
