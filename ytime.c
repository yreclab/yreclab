/* ytime.f -- translated by f2c (version 20100827).
...
/* Subroutine */ int ytime_(doublereal *eg, doublereal *hcomp, doublereal *hd,
	...
	doublereal *hr11, doublereal *hr12, doublereal *hr13, doublereal *hf1,
	 doublereal *hf2, doublereal *qdp, doublereal *qdt, integer *jxbeg)
{
...
/*     CALCULATE HELIUM BURNING RATE AT TMAX */
	...
	engeb_(&egg11, &egg22, &egg33, &egg44, &egg55, &qed, &qet, &sum1, &dl,
		 &tl, qdt, qdp, &x, &y, &z__, &xhe3, &xc12, &xc13, &xn14, &
		xn15, &xo16, &xo17, &xo18, &xh2, &xli6, &xli7, &xbe9, &iu, &
		hr1[1], &hr2[1], &hr3[1], &hr4[1], &hr5[1], &hr6[1], &hr7[1], 
		&hr8[1], &hr9[1], &hr10[1], &hr11[1], &hr12[1], &hr13[1], &
		hf1[1], &hf2[1]);
	e = sum1;
	eg[1] = egg11;
	eg[2] = egg22;
