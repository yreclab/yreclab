/* wind.f -- translated by f2c (version 20100827).
...
/* Subroutine */ int wind_(doublereal *bl, doublereal *delts, doublereal *
	...
	ljdot, doublereal *omegas, doublereal *sjtot, doublereal *smass, 
	doublereal *teffl, doublereal *hicz, doublereal *hjm)
{
    /* Format strings */
...
/* MHP 12/91 CAP LOSS RATE AT WSAT. */
	...
	d__4 = cwind_1.exw - 1.;
	dwtest = *delts / *hicz * cwind_1.factor * pow_dd(&d__1, &
...
L5:
	    ...
	    d__3 = min(w,wsat);
	    d__4 = cwind_1.exw - 1.;
	    rot_1.wnew = ws - dt / *hicz * cwind_1.factor * pow_dd(&d__1, &
		    cwind_1.exmd) * w * pow_dd(&d__2, &cwind_1.exr) * pow_dd(
		    smass, &cwind_1.exm) * pow_dd(&d__3, &d__4);
