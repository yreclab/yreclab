/* wrtmonte.f -- translated by f2c (version 20100827).
...
/* Subroutine */ int wrtmonte_(doublereal *hcomp, doublereal *hd, doublereal *
	...
	logical *lc, integer *m, integer *model, doublereal *dage, doublereal 
	*ddage, doublereal *smass, doublereal *teffl, doublereal *bl, 
	doublereal *gl, logical *lshell, integer *jxbeg, integer *jxmid, 
	integer *jxend, integer *jcore, integer *jenv, doublereal *tlumx, 
	doublereal *trit, doublereal *tril, doublereal *ps, doublereal *ts, 
	doublereal *rs, doublereal *cfenv, doublereal *ftri, doublereal *
	hstot, doublereal *omega, doublereal *rll, integer *iconv, integer *
	nk, integer *nn)
{
    /* Format strings */
