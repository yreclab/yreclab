/* momi.f -- translated by f2c (version 20100827).
...
/* $$$$$$ */
/* Subroutine */ int momi_(doublereal *eta2, doublereal *hd, doublereal *hr, 
	doublereal *hs, doublereal *hs2, integer *jstart, integer *jend, 
	doublereal *omega, doublereal *r0, doublereal *hi, doublereal *qiw, 
	integer *m)
{
